...
<main role="main">
    ...
    <style>
        ...
        .boxgraduacao {
            margin: 2vmin; border: 1px solid #ccc!important; border-radius: 16px; padding: 2vmin; min-height: 25vmin;
        }
        .boxgraduacao img {
            margin-top: 2vmin;
        }
                                    ...
                                    <div class="col-sm-12">
                                        <div class="row">
                                            <div class="progress barra-progresso-plano-carreira">
                                                <div class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar"
                                                     style="width: <?= $percentualProgresso ?>%;" aria-valuenow="<?= $percentualProgresso ?>"
                                        ...
                                        <div class="row form-group">
                                            <div class="col-xs-6">
                                                ...
                                                <img src="<?php echo asset('/admin/arquivos/'. $planoAtual->getImagem() )?>" width='50vmin' class="card-img-top pull-center" alt="...">
                                            </div>
                                            <div class="col-xs-6 text-right">
                                                <h6><?= $proximoPlano->getPontos() ?> pontos</h6>
                                                <?= $proximoPlano->getGraduacao() ?>
                                                <img src="<?php echo asset('/admin/arquivos/'. $proximoPlano->getImagem() )?>" width='50vmin' class="card-img-top pull-center" alt="...">
                                            </div>
                                        </div>
                                    ...
                                    <form class="form-inline periodo" action="">
                                        ...
                                        <div class="form-group">
                                            <select class="form-control" id="ano"  name="ano">
                                                <option value="">Selecine o Ano</option>
                                                <?php
...
<?php if(!$statusCliente): ?>
    <h5><span class="alert alert-danger col-xs-12"> Status atual: <?= 'Inativo' ?></span></h5>
<?php else:?>
    <h5><span class="alert alert-success col-xs-12"> Status atual: <?= 'Ativo' ?></span></h5>
<?php endif ?>
<div class="row">
    <div class="col-xs-12">
        <div class="panel panel-default">
                        ...
                        <div class='col-sm-4'>
                            <div class="card text-center boxgraduacao">
                                ...
                                <?php if($objImagemGraduacaoAnterior != null): ?>
                                    <img src="<?php echo asset('/admin/arquivos/'. $objImagemGraduacaoAnterior )?>" width='50vmin' class="card-img-top pull-center" alt="...">
                                <?php endif?>
                                <div class="card-body">
                                    <h5 class="card-title"><strong> <?php echo $graduacaoAnterior ?></strong></h5>
                                </div>
                            </div>
                        </div>
                        <div class='col-sm-4'>
                            <div class="card text-center boxgraduacao">
                                ...
                                <?php if($objImagemGraduacaoAtual != null): ?>
                                    <img src="<?php echo asset('/admin/arquivos/'. $objImagemGraduacaoAtual)?>" width='50vmin' class="card-img-top pull-center" alt="...">
                                <?php endif?>
                                <div class="card-body">
                                    <h5 class="card-title"><strong><?php echo $graduacaoAtual ?></strong></h5>
                                </div>
                            </div>
                        </div>
                        <div class='col-sm-4'>
                            <div class="card text-center boxgraduacao">
                                ...
                                <?php if($objImagemMaiorGraduacao != null): ?>
                                    <img src="<?php echo asset('/admin/arquivos/'. $objImagemMaiorGraduacao)?>" width='50vmin' class="card-img-top pull-center" alt="...">
                                <?php endif?>
                                <div class="card-body">
                                    <h5 class="card-title"><strong><?php echo $maiorGraduacao ?></strong></h5>
                                </div>
                            </div>
                        </div>
                    </div>
...
<div class="col-xs-12" style="margin-top: 15px;">
    <div class="row">
        <small class="text-muted">
            Obs.: Os pontos de carreira são calculados utilizando o horário de Brasília.
        </small>
    </div>
</div>
...
<!--            <h4 class='text-center'> Graduação no período de --><?php //echo $meses[$mesSelecionado] ?><!-- <span class='alert alert-primary' id='infoProntos' hidden> </span> </h4>-->
<!--        </div>-->
<!--        <div class="panel-body">-->
...
<!--                        <td data-title="Pontos" class="text-right">--><?php //echo $data[1]; ?><!--</td>-->
<!--                    </tr>-->
<!--                --><?php //endforeach; ?>
<!--                </tbody>-->
<!--                <tfoot>-->
...
<!--                    <td data-title="" class="text-right"><b> --><?php //echo number_format($totalPontos, 0, ',', '.') ?><!--</b></td>-->
<!--                </tr>-->
<!--                </tfoot>-->
<!--            </table>-->
<!--        </div>-->
