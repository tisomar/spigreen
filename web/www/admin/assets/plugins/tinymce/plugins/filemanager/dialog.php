...
//php sorting
                                ...
                                <div class="filters">
                                    <div class="row-fluid">
                                        ...
                                        <div class="span6 types">
                                            ...
                                            <?php } ?>
                                            <input accesskey="f" type="text" class="filter-input" id="filter-input" name="filter" placeholder="<?php echo fix_strtolower(lang_Text_filter); ?>..." value="<?php echo $filter; ?>"/><?php
                ...
                <div class="row-fluid ff-container">
                    <div class="span12">	    
                        ...
                        if (@opendir($current_path . $subfolder . $subdir) === FALSE)
                        {
                            ?>
                            <br/>
                            <div class="alert alert-danger">There is an error! The upload folder there isn't. Check your config.php file. </div>
                            <?php
                        }
                        else
                        {
                                                    ...
                                                    <form action="force_download.php" method="post" class="download-form" id="form<?php echo $nu; ?>">
                                                        ...
                                                        elseif (($is_video || $is_audio) && in_array($extension_lower, $jplayer_ext))
                                                        {
                                                            ...
                                                            ?>"
                                                               ...
                                                               echo $current_path . $subfolder . $subdir . $file;
                                                               ;
                                                               ?>"
    ...
    <?php if (isset($files_prevent_duplicate)): ?>
