...
list($root_path) = explode ('admin', $_SERVER['SCRIPT_FILENAME']);
$web_path = $root_path;
$root_path = rtrim(str_replace($_SERVER['DOCUMENT_ROOT'], '', $root_path), '/');
$url = $scheme . $_SERVER['SERVER_NAME'] . $root_path;
// -------------------

$base_url = $scheme . $_SERVER['SERVER_NAME'] . $root_path;  // DON'T TOUCH (base url (only domain) of site (without final /)).
$upload_dir = '/arquivos/filemanager/'; // path from base_url to base of upload folder (with start and final /)
$current_path = $web_path . 'arquivos/filemanager/'; // relative path from filemanager folder to upload folder (with final /)
//thumbs folder can't put inside upload folder
$thumbs_base_path = '../../../../../arquivos/filemanager_thumbs/'; // relative path from filemanager folder to thumbs folder (with final /)
