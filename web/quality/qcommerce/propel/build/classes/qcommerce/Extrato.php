...
class Extrato extends BaseExtrato
{
    ...
    public static $tiposDesc = array(
        self::TIPO_BONUS_DESTAQUE => 'Bônus destaque',
        self::TIPO_BONUS_DESEMPENHO => 'Bônus desempenho',
        self::TIPO_BONUS_ACELERACAO => 'Bônus aceleração',
        self::TIPO_BONUS_FRETE => 'Bônus frete',
        ...
        self::TIPO_TRANSFERENCIA => 'Transferência de Bônus',
        self::TIPO_DISTRIBUICAO_REDE => 'Distribuição de Rede',
        self::TIPO_VENDA_HOTSITE => 'Bônus Hotsite'
    );
