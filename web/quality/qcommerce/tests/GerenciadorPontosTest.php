...
/**
 * Description of GerenciadorPontosTest
 *
 * @author André Garlini
 */
class GerenciadorPontosTest extends MyDatabaseTestCase
{
    /**
    ...
    /**
     * Verifica que uma exceção é lançada ao tentar distribuir os pontos de um pedido cancelado.
     *
     * @expectedException LogicException
     */
    public function testDistribuicaoPedidoCancelado()
    {
        $gerenciador = new GerenciadorPontos($con = Propel::getConnection());
        
        $pedido = new Pedido();
        $pedido->setStatus(PedidoPeer::STATUS_CANCELADO);
    ...
    /**
     * Verifica que nenhum extrato é criado quando o cliente do pedido nao está na rede.
     */
    public function testDistribuicaoClienteSemPatrocinador()
    {
        $gerenciador = new GerenciadorPontos($con = Propel::getConnection());
        ...
        $this->assertEquals(0, ExtratoQuery::create()->count());
    }
    
    
    public function testIndicacaoDireta()
    {
        $gerenciador = new GerenciadorPontos($con = Propel::getConnection());
        ...
        //O patrocinador deve possuir um extrato com 40 pontos = 20% de (80 + 120) (kit + plano)
        $this->assertEquals(40, $this->somaPontosCliente($patrocinador, Extrato::TIPO_INDICACAO_DIRETA, $con));
     ...
     *
     * @param Cliente $cliente
     * @param string|null $tipoExtrato
     * @param PropelPDO|null $con
     * @return float
     */
    protected function somaPontosCliente(Cliente $cliente, $tipoExtrato = null, PropelPDO $con = null)
    {
        $query = ExtratoQuery::create()
