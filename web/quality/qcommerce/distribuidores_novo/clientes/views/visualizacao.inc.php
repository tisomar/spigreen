...
<div class="modal fade custom-width" id="modal-adicionar-clientes">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="<?php echo $root_path ?>/distribuidores_novo/clientes/actions/cadastro.action.php?pag=visualizacao" method="POST" class="form-horizontal form-cadastro-clientes">
                    ...
                    <div class="container">
                        ...
                        <div class="col-md-5 col-lg-6">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-8">
                                    <input type="email" class="form-control" id="email" placeholder="examplo@email.com.br" name="cliente_distribuidor[EMAIL]" value="<?php echo isset($arrClienteDistribuidor) && array_key_exists('EMAIL', $arrClienteDistribuidor) ? escape($arrClienteDistribuidor['EMAIL']) : '' ?>" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-sm-2 col-md-12 col-lg-3">
                                ...
                                <div class="col-lg-8">
                                    <input type="text" class="form-control" id="nome_razao_social" placeholder="<?php echo escape(_trans('agenda.nome_completo')); ?>" name="cliente_distribuidor[NOME_RAZAO_SOCIAL]" value="<?php echo isset($arrClienteDistribuidor) && array_key_exists('EMAIL', $arrClienteDistribuidor) ? escape($arrClienteDistribuidor['NOME_RAZAO_SOCIAL']) : '' ?>" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-sm-2 col-md-12 col-lg-3">
