<form role="form" class="form-horizontal form-inline form-groups-bordered form-search-cli">
    <div class="col-lg-11" style="margin-left: -15px;">
        ...
        <input type="text" name="filter[Nome]" value="<?php echo (isset($arrFilter['Nome']) ? $arrFilter['Nome'] : ''); ?>" class="form-control input-xs" id="form-filter-nome" placeholder="<?php echo escape(_trans('agenda.nome')); ?>">
        ...
        <div class="div-select" style="width: 150px">
            <select class="selectboxit" name="filter[Comprou]">
                ...
                <optgroup label="<?php echo escape(_trans('agenda.compras')); ?>">
                    <option value="1"<?php echo (isset($arrFilter['Comprou']) && $arrFilter['Comprou'] == 1) ? ' selected' : ''; ?>><?php echo escape(_trans('agenda.sim_comprou')); ?></option>
                    <option value="2"<?php echo (isset($arrFilter['Comprou']) && $arrFilter['Comprou'] == 2) ? ' selected' : ''; ?>><?php echo escape(_trans('agenda.nao_comprou')); ?></option>
                </optgroup>
                <optgroup label="<?php echo escape(_trans('agenda.agendamentos')); ?>">
                    <option value="3"<?php echo (isset($arrFilter['Comprou']) && $arrFilter['Comprou'] == 3) ? ' selected' : ''; ?>><?php echo escape(_trans('agenda.com_agendamento')); ?></option>
                    <option value="4"<?php echo (isset($arrFilter['Comprou']) && $arrFilter['Comprou'] == 4) ? ' selected' : ''; ?>><?php echo escape(_trans('agenda.sem_agendamento')); ?></option>
                </optgroup>
            </select>
        </div>
    ...
    <div class="col-lg-1" style=" margin-left: -15px;">
        <button type="submit" class="btn btn-default btn-icn icoon-right">
