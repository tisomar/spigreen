<div class="col-md-5 col-lg-6">
    ...
    <div class="form-group row">
        ...
        <div class="col-lg-8">
            <input type="text" class="form-control" id="nome_razao_social" placeholder="<?php echo escape(_trans('agenda.nome')); ?>" name="cliente_distribuidor[NOME_RAZAO_SOCIAL]" value="<?php echo isset($arrClienteDistribuidor) && array_key_exists('EMAIL', $arrClienteDistribuidor) ? escape($arrClienteDistribuidor['NOME_RAZAO_SOCIAL']) : ''?>" required>
        </div>
    </div>
    <div class="form-group row">
        <div class="col-sm-2 col-md-12 col-lg-3">
...
<div class="col-md-6">
    ...
    <div class="form-group row">
        ...
        </div><?php $collEstados = EstadoQuery::create()->orderByNome()->find(); ?>
        <div class="col-lg-8">
