...
<div class="modal fade custom-width" id="modal-adicionar-listas">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="<?php echo $root_path ?>/distribuidores_novo/listas/actions/cadastro.action.php" method="POST" class="form-horizontal form-cadastro-listas">
                ...
                <div class="modal-body">
                    <div class="container">
                        <?php include __DIR__ . '/form-cadastro.php'; ?>
                    </div>
                </div>
...
<div class="modal fade" id="delete-item">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="<?php echo $root_path ?>/distribuidores_novo/listas/actions/excluir.action.php" method="POST">
                <input type="hidden" name="id" value="-1"/>
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
...
<div class="modal fade" id="enviar-sms">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="<?php echo $root_path ?>/distribuidores_novo/listas/actions/sms.action.php" method="POST">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
...
<div class="modal fade" id="enviar-email">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="<?php echo $root_path ?>/distribuidores_novo/listas/actions/email.action.php" method="POST">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
