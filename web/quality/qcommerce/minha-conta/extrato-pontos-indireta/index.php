...
$strIncludesKey = 'minha-conta-extrato-pontos-indireta';
include QCOMMERCE_DIR . "/includes/security.php";
include QCOMMERCE_DIR . "/includes/head.php";
?>

<body itemscope itemtype="http://schema.org/WebPage" data-page="minha-conta-extrato-pontos-indireta">
...
<main role="main">
    ...
    Widget::render(
        ...
        array('links' => array('Home' => '/home', 'Minha Conta' => 0, 'Bônus de Equipe Indireta' => ''))
    );
    Widget::render('general/page-header', array('title' => 'Bônus de Equipe Indireta'));
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-md-9">
                ...
                <form action="<?php echo get_url_site() .
                    '/minha-conta/extrato-pontos-indireta/' ?>" role="form" method="get" class="form-disabled-on-load">
                    <?php Widget::render(
                    ...
                    <div class="col-xs-12">
                        <?php if (count($pager) > 0) : ?>
                            ...
                            <div class="table-vertical">
                                <table class="table table-striped">
                                    ...
                                    if ($extrato->getPedido()) :
                                        $totalPontos = $extrato->getPedido()->getTotalPontosProdutos(Extrato::TIPO_INDICACAO_INDIRETA);
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?= escape($extrato->getObservacao()) . $nivel ?></td>
                            ...
                            Widget::render('components/pagination', array(
                                'pager' => $pager,
                                'href' => get_url_site() . '/minha-conta/extrato-pontos-indireta/',
                        ...
                        <div class="alert alert-success" style='background: #A1E63A'>
                            <h5><strong>Informativo!</strong> <?php echo $mensagemResgatePontosIndireto; ?></h5>
                        </div>
                    </div>
                </div>
            </div>
