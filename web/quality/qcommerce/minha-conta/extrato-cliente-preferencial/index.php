<?php
require __DIR__ . '/actions/extrato-cliente-preferencial.actions.php';

use QPress\Template\Widget;

$strIncludesKey = 'minha-conta-extrato-cliente-preferencial';
include QCOMMERCE_DIR . "/includes/security.php";
include QCOMMERCE_DIR . "/includes/head.php";
?>

<body itemscope itemtype="http://schema.org/WebPage" data-page="minha-conta-extrato-cliente-preferencial">
...
<main role="main">
    ...
    Widget::render(
        ...
        array('links' => array('Home' => '/home', 'Minha Conta' => 0, 'Extrato de pontos' => ''))
    );
    Widget::render('general/page-header', array('title' => 'Extrato de pontos'));
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-md-9">
                ...
                <form action="<?php echo get_url_site() .
                    '/minha-conta/extrato-cliente-preferencial/' ?>" role="form" method="get" class="form-disabled-on-load">
                    <?php
                    Widget::render(
                        ...
                        <?php if (count($pager) > 0) : ?>
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    ...
                                    <strong><?php echo str_replace('.', ',', $totalPontosPeriodo) ?></strong>.
                                </div>
                            </div>
                            ...
                            <div class="table-vertical">
                                <table class="table table-striped">
                                    ...
                                    foreach ($pager as $extrato):  ?>
                                        <tr>
                                            <td class="text-center"><?php echo $extrato->getPontos() ?></td>
                            ...
                            Widget::render('components/pagination', array(
                                'pager' => $pager,
                                'href' => get_url_site() . '/minha-conta/extrato-cliente-preferencial/',
