...
$strIncludesKey = 'minha-conta-extrato-transferencia';
...
<main role="main">
    ...
    Widget::render(
        ...
        array('links' => array('Home' => '/home', 'Minha Conta' => 0, 'Extrato de Transferência Recebida' => ''))
    );
    Widget::render('general/page-header', array('title' => 'Extrato de Transferência Recebida'));
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-md-9">
                ...
                <form action="<?php echo get_url_site() .
                    '/minha-conta/extrato-transferencia/' ?>" role="form" method="get" class="form-disabled-on-load">
                    <?php Widget::render(
                        ...
                        <?php if (count($pager) > 0) : ?>
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    <span class="<?php icon('info'); ?>"></span> Total recebido no período R$
                            ...
                            <div class="table-vertical">
                                <table class="table table-striped">
                                    ...
                                    <?php foreach ($pager as $transferencia) : /** @var $extrato Extrato */
                                        $clienteRemetente = ClientePeer::retrieveByPK($transferencia->getClienteRemetenteId());
                                    ?>
                                        <tr >
                            ...
                            Widget::render('components/pagination', array(
                                'pager' => $pager,
                                'href' => get_url_site() . '/minha-conta/extrato-transferencia/',
