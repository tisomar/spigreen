...
try {
    ...
    /** @var $extrato Extrato */
    foreach ($query->find() as $extrato) :
        $totalPontosPeriodo = $extrato->getOperacao() == '+' ? $totalPontosPeriodo + $extrato->getPontos() :
            $totalPontosPeriodo - $extrato->getPontos();
    endforeach;
...
$mensagemResgatePontosRecompra = $configPontuacaoMensal->getMensagemResgatePontosRecompra();