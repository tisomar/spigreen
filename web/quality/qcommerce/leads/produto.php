...
include("actions/leads.produtos.actions.php");
    ...
    <div id="contact-page" class="container">
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-8">
                <h1 class="title"><?php //echo escape(_trans('title.leads_produto.title_page')) ?></h1>
                <?php echo _mostrarConteudoDescricao('19'); ?>
...
<div class="container">
    <div class="row">
        <div class="col-xs-12 title">
            <?php echo _mostrarConteudoDescricao('20'); ?>
        </div>
    </div>
</div>
