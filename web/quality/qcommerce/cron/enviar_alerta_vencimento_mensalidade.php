...
/*
 * Script que envia um e-mail de alerta ao cliente quando faltar 01 dia para o vencimento da mensalidade.
 */
...
foreach ($query->find() as $cliente) { /* @var $cliente Cliente */
    try {
        QPress\Mailing\Mailing::enviarAlertaVencimentoMensalidade($cliente);
    } catch (Exception $ex) {
