...
if ($participacaoResultado) {
    echo "Executando preview participação resultados (Bônus desempenho) {$participacaoResultado->getId()} ...", $nl;

    $gerenciador = new BonificacaoDesempenho($con = Propel::getConnection(), $logger);
