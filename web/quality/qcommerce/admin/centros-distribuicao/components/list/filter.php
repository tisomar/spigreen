...
$form->addElement(new Element\Textbox("Descrição", "filter[Descricao]", array(
    "value" => $request->query->get('filter[Descricao]', null, true),
)));

$form->addElement(new Element\Textbox("CEP", "filter[Cep]", array(
    "value" => $request->query->get('filter[Cep]', null, true),
)));
