...
$form->addElement(new Element\Number("Quantidade de Clientes ativos", "data[QTD_CLIENTES_ATIVOS]", array(
    "value" => $object->getQuantidadeClientesAtivos(),
    "required" => true,
    'min'   => '0'
)));

$form->addElement(new Element\Number("Quantidade de níveis pagantes", "data[NIVEIS_PAGANTES]", array(
    "value" => $object->getNiveisPagantes(),
    "required" => true,
    'min'   => '0'
)));
