    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0" class="table table-hover table-striped">
        ...
        <tbody>
            ...
            foreach ($pager->getResult() as $object) { /* @var $object Galeria */
                ?>
                <tr>
                    <td data-title="Galeria">
                        <?php echo $object->getNome(); ?>
                    </td>
                    <td data-title="Qtd. imagens"><?php echo $object->countGaleriaArquivos(); ?> <a href="<?php echo $config['routes']['registration'] . '?id=' . $object->getId() ?>">ver imagens</a></td>
