...
<div class="table-responsive">
    <table width="100%" cellpadding="0" cellspacing="0" border="0" class="table table-hover table-striped">
        ...
        foreach ($pager->getResult() as $object) { /* @var $object FaixasDistribuicaoBinaria */
            ?>
            <tr>
                <td data-title="Pontos Inicial"><?php echo $object->getPontuacaoInicial() ?></td>
                <td data-title="Pontos Final"><?php echo $object->getPontuacaoFinal() ?></td>
                <td data-title="Teto Pago"><?php echo $object->getPontosTeto() ?></td>
                <td data-title="Teto Pago"><?php echo $object->getPlano()->getNome() ?></td>
