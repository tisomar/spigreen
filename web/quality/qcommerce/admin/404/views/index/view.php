        ...
        <div id="page-container">
            ...
            <div id="page-content">
                <div id='wrap'>
                    <div id="page-heading">
                        <?php
                        if (file_exists(QCOMMERCE_DIR . '/admin/' . $router->getModule() . '/components/' . $router->getAction() . '/breadcrumb.php')) {
                            include QCOMMERCE_DIR . '/admin/' . $router->getModule() . '/components/' . $router->getAction() . '/breadcrumb.php';
                        }
                        ?>
                        ...
                        <div class="options">
                            <div class="btn-toolbar">
                                <div class="btn-group">
                                    ...
                                    } elseif (file_exists(QCOMMERCE_DIR . '/admin/_2015/components/' . $router->getAction() . '/links.php')) {
                            ...
                            <div class="col-md-12">
                                <div class="panel panel-primary">
                                    <div class="panel-body">
                                        ...
                                        <?php
                                        if (!file_exists(QCOMMERCE_DIR . '/admin/' . $router->getModule() . '/components/' . $router->getAction() . '/content.php')) {
                                            throw new Exception('Você deve criar o arquivo "/' . $router->getModule() . '/components/' . $router->getAction() . '/content.php" do seu módulo');
                                        }
                                        include QCOMMERCE_DIR . '/admin/' . $router->getModule() . '/components/' . $router->getAction() . '/content.php';
                                        ?>
                                    </div>
                                </div>
                            </div>
