...
<div class="table-responsive">
    <table width="100%" cellpadding="0" cellspacing="0" border="0" class="table table-hover table-striped">
        ...
        <tbody>
            <?php
            foreach ($pager->getResult() as $object) { /* @var $object FaturamentoDireto */
                ?>
                <tr>
                    <td data-title="Padrão"><?php echo $object->getPadrao()
                            ? '<label class="label label-success"><i class="icon-ok"></i> SIM</label>'
                            : '<label class="label label-default"><i class="icon-remove"></i> NÃO</label>'; ?></td>
