...
namespace Integrations\Models\Bling\Services\ContasPagar;

use Integrations\Helper\Helper;
use Integrations\Models\Bling\Services\AbstractService;

class ContasPagarBling extends AbstractService {

    /**
     * URI Builder constants
     */
    const URL_APPEND = 'contapagar';
    const DS = '/';
