...
namespace Integrations\Models\Bling\Services\Produto;
 ...
 *
 *
 * @package Integrations\Models\Bling\Services\Produto
 */
class ProdutoBling extends AbstractService{

    /**
     * URI Builder constants
     */
    const URL_APPEND = 'produto';
    const DS = '/';
     ...
     */
    protected $allowedMethods = array('POST', 'GET', 'DELETE');
    ...
    public function validate($method){
        ...
        if(($method == 'DELETE' || $method == 'GET') && Helper::isValidId($this->getCodigoid())){
            return false;
        }
