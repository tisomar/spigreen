...
namespace Integrations\Models\Bling\Services\ContasReceber;

use Integrations\Helper\Helper;
use Integrations\Models\Bling\Services\AbstractService;

class ContasReceberBling extends AbstractService {

    /**
     * URI Builder constants
     */
    const URL_APPEND = 'contareceber';
    const DS = '/';
    ...
    /**
     * ContasReceberBling constructor.
