...
class Cache
{
    ...
    public function __construct($config = null)
    {
        ...
        $this->setCachePath(QCOMMERCE_DIR . '/config/cache/');
    ...
    public function isExpired($key, $expiration) {
        
        $cachedData = $this->_loadCache();
        
        if (!isset($cachedData[$key]['expire'])) {
            return true;
        }
        
        return $this->_checkExpired($cachedData[$key]['expire'], $expiration);
    }
