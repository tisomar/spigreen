...
if ($objProdutoDetalhe->getId() === 199):
    $totalRequired = 0;
    ...
    >
        ...
        foreach ($relatedProducts as $product):
            ...
            // preço com desconto quando está no valor original
            // $price = $isAcessorio ? $variacao->getValor() : $variacao->getValorBase() * 0.4;
...
<script>
    $('.qtd-produto-kit').on('change', function() {      
        ...
        // </?php if($objProdutoDetalhe->getId() === 199):?>
        //     if($(this).val() > 4) {
